...
class LifeDigestNode(BaseModel):
    id: int | None = None
    node_date: str = Field(default_factory=lambda: shanghai_now().date().isoformat())
    source_kind: Literal["environment", "snapshot", "trace", "merged"] = "merged"
    title: str = ""
    summary: str = ""
    life_domain: Literal["work", "body", "routine", "study", "logistics", "recovery", "hobby", "home"] = "routine"
    salience: float = 0.5
    novelty_score: float = 0.5
    carry_forward: float = 0.5
    linked_snapshot_id: int | None = None
    linked_trace_id: int | None = None
    linked_env_ref: str | None = None
...
class MemorySummaryRun(BaseModel):
    id: int | None = None
    summary_level: Literal["day", "week", "month", "year"] = "day"
    window_start: str = ""
    window_end: str = ""
    created_at: str = Field(default_factory=lambda: format_utc_instant_z(datetime.utcnow()))
    ...
    source_summary_run_ids_json: str = "[]"
    source_life_node_ids_json: str = "[]"
    summary_pack_json: str = "[]"
    bridge_pack_json: str = "[]"
    event_line_digest_json: str = "[]"
    day_digest_json: str = "{}"
...
class MemorySummaryPreviewRequest(BaseModel):
    summary_level: Literal["day", "week", "month", "year"]
