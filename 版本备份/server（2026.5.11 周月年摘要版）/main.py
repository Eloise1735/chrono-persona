...
async def lifespan(app: FastAPI):
    ...
    memory_summary_engine = MemorySummaryEngine(db, llm, prompt_manager)
    ...
    sm.set_memory_summary_engine(memory_summary_engine)
    ...
    set_dependencies(
        ...
        memory_summary_engine=memory_summary_engine,
    )
